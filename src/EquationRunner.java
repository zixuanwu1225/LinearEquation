...
public class EquationRunner {
    public static void main(String[] args) {
        ...
        String secondInteger = coordinates2.substring(removeParentheses2.length(), p1Placement - 1);
        ...
        String thirdInteger = coordinates1.substring(p1Placement, removeParentheses2.length() - 1);
        ...
        String fourthInteger = coordinates2.substring(removeParentheses2.length(), p1Placement - 1);
